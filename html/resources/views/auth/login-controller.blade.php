 ...
 @section('content')
     <div class="flex justify-center items-center min-h-screen">
         <div class="w-96 max-w-sm">
             <div class="text-black text-3xl font-bold -mt-8 my-8 mx-8 ms-8 me-8 "><br> Iniciar sesión</div>
 
             <form class="bg-white shadow-md rounded px-8 pt-6 pb-9 mb-4" method="POST" action="{{ route('login') }}">
                 @csrf
