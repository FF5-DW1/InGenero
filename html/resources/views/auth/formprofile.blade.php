                ...
                <form class="text-left" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <input id="idiomas" name="idiomas" type="text"
                            class="form-control @error('idiomas') error-borderred @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <input id="date_of_birth" name="date_of_birth" type="date"
                            class="form-control @error('date_of_birth') error-borderred @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <input id="height" name="height" type="text"
                            class="form-control @error('height') error-borderred @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <input id="weight" name="weight" type="text"
                            class="form-control @error('weight') error-borderred @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <input id="eyes_color" name="eyes_color" type="text"
                            class="form-control @error('eyes_color') error-borderred @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <input id="hair_color" name="hair_color" type="text"
                            class="form-control @error('hair_color') error-borderred @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <input id="additional_info" name="additional_info" type="text"
                            class="form-control @error('additional_info') error-borderred @enderror"
                        ...
                        <div class="mb-6">
                            ...
                            <input id="artistic_skills" name="artistic_skills" type="text"
                                class="form-control @error('artistic_skills') error-borderred @enderror"
                        ...
                        <div class="mb-4">
                            ...
                            <input id="profile_photo" name="profile_photo[]" type="file"
                                class="form-control-file @error('profile_photo') error-borderred @enderror"
                            ...
                            <div class="mb-4">
                                ...
                                <input id="video_url" name="video_url" type="text" class="form-control"
                                    value="{{ old('video_url', $formprofile->video_url) }}" />
                            </div>
