...
<div class="py-10 mt-10 fixed top-0 bg-cover bg-center lg:h-800 w-1920 relative">
    <img src="img/imagenhero.jpg" alt="" class="w-full h-80 z-10 object-cover">
    <div class="absolute bottom-0 right-0 p-4">
        <h1 class="text-2xl font-extrabold leading-none text-white lg:text-4xl">Administrador@</h1>
    </div>
</div>
    ...
    <div class="md:w-6/12 lg:w-4/12 bg-white p-6">
        ...
        <form action="{{ route('register') }}" method="POST" novalidate>
            ...
            <div class="mb-4">
                ...
                <input id="nationality" name="nationality" type="text" class="border-green-300 p-2 w-full rounded-lg @error('email') border-red-500 @enderror bg-green-100" value="{{ old('nationality') }}" />
                @error('nacionalidad')
                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }} </p>
                @enderror
            </div>
