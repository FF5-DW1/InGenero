{{-- <div>
    <nav class=" bg-emerald-300 bg-opacity-20 Rectangle57 w-[395px] h-[125px]  left-0 top-[4px] space-x-7 border-gray-200 dark:bg-gray-900">
       <div class="Rectangle57 w-[395px] h-[125px] left-0 top-[4px]  bg-emerald-300 bg-opacity-20"></div> 
...
<div>
    <nav class="bg-emerald-300 bg-opacity-20">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center  rounded p-2">
                <img src="/img/logoencabezado.png" class="h-8 mr-3" alt="InGenero" />
            </a>
            {{-- bg-emerald-300 bg-opacity-20 --}}
            <button data-collapse-toggle="navbar-default" type="button"
                class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                aria-controls="navbar-default" aria-expanded="false">
                <span class="sr-only">Menu</span>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-emerald-300 bg-opacity-20 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:hover:text-gray-700 dark:bg-gray-900 md:dark:bg-gray-700 dark:border-gray-700">
                    <li>
                        <a href="/register"
                            class="enlace block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-gray-700 md:p-0 dark:text-white md:dark:hover:text-gray-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                            aria-current="page">Register</a>
