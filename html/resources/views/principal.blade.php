...
@section('content')
    ...
    <section class="flex-col w-full flex items-center justify-center mt-14">
        ...
        <div class="relative max-w-screen-xl">
            <video class="p-4 rounded-3xl w-full opacity-50" src="video/631382089.mp4" autoplay="true" muted="true"
                loop="true"></video>
    ...
    <section class="flex-col w-full flex items-center justify-center mt-14">
        ...
        <div class="bg-red-500 w-full flex justify-center items-center">
            <div id="default-carousel" class="relative w-full" data-carousel="slide">
                <!-- Carousel wrapper -->
                <div class="relative h-96 overflow-hidden md:h-96">
                    <!-- Perfil 1 -->
                    <div class="swiper-slide duration-700 h-96 mt-4 ease-in-out flex items-center justify-center md:w-1/3"
                        data-carousel-item>
                        <div class="max-w-xs bg-white p-4 rounded-xl flex-col items-center justify-center">
                            <a href="#">
                                <img class="mb-4" src="/img/imagenhero.jpg" alt="imagen perfil" />
                            ...
                            <div class="flex-col justify-center items-center mt-4">
                                <a href="#"
                                class= text-center rounded-3xl inline-flex items-center px-3 py-2 text-xl font-medium">
                    ...
                    <!-- Perfil 2 -->
                    <div class="duration-700 h-96 mt-4 ease-in-out flex items-center justify-center md:w-1/3"
                        data-carousel-item>
                        <div class="max-w-xs bg-white p-4 rounded-xl flex-col items-center justify-center">
                            <a href="#">
                                <img class="mb-4" src="/img/imagenhero.jpg" alt="imagen perfil" />
                    ...
                    <!-- Perfil 4 -->
                    <div class="duration-700 h-96 mt-4 ease-in-out flex items-center justify-center hidden md:flex md:w-1/3"
                        data-carousel-item>
                        <div class="max-w-xs bg-white p-4 rounded-xl flex-col items-center justify-center">
                            <a href="#">
                                <img class="mb-4" src="/img/imagenhero.jpg" alt="imagen perfil" />
    ...
    {{-- <div class="bg-red-500 w-full p-4">
        ...
        <div class="bg-red-500 w-full">
            <div id="default-carousel" class="relative w-full" data-carousel="slide">
                ...
                <div class="relative h-96 overflow-hidden md:h-96">
                    <!-- Perfil 1 -->
                    <div class="swiper-slide duration-700 h-96 mt-4 ease-in-out flex items-center justify-center" data-carousel-item>
                        <div class="max-w-xs  bg-white  p-4 rounded-xl flex-col items-center justify-center">
                            <a href="#">
                                <img class="mb-4" src="/img/imagenhero.jpg" alt="imagen perfil" />
                            </a>
