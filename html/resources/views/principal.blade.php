...
@section('content')
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0">
                <h1 class="oh swiper-title"><span class="d-inline-block" data-caption-animate="slideInUp" data-caption-delay="0">Vivir es puro teatro</span></h1>
                <p class="big swiper-text" data-caption-animate="fadeInLeft" data-caption-delay="300">Únete al proyecto para que todos juntos podamos crecer y desarrollar nuestro arte</p><a class="button button-lg button-primary button-winona button-shadow-2" href="nosotras" data-caption-animate="fadeInUp" data-caption-delay="300">Mas información</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-lg-7 offset-lg-1 offset-xxl-0">
                <h1 class="oh swiper-title"><span class="d-inline-block" data-caption-animate="slideInDown" data-caption-delay="0">nuestras actrices</span></h1>
                <p class="big swiper-text" data-caption-animate="fadeInRight" data-caption-delay="300">Date una vuelta por la galería de talentos, seguro que te sorprenderá</p>
                <div class="button-wrap oh"><a class="button button-lg button-primary button-winona button-shadow-2" href="profiles" data-caption-animate="slideInUp" data-caption-delay="0">Perfiles</a></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="oh-desktop">
            ...
            <article class="services-terri wow slideInUp">
              ...
              <div class="services-terri-caption">
                <h5 class="services-terri-title"><a target="en_blank" href="https://www.ingenero.es/">Web In Genero</a></h5>
              </div>
            </article>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
          <div class="oh-desktop">
            ...
            <article class="services-terri wow slideInUp">
              ...
              <div class="services-terri-caption">
                <h5 class="services-terri-title"><a target="en_blank" href="https://nosotras.app/">Nosotras App</a></h5>
              </div>
            </article>
          </div>
        </div>
        ...
        <div class="row justify-content-end">
          <div class="col-sm-8 col-md-7 col-lg-5">
            <div class="cta-modern">
              ...
              <p class="lead">Desde aquí te animamos a que con tu aportación ayudes a financiar la formación de nuestras estrellas para que puedan conseguir sus metas profesionales</p>
              <p class="cta-modern-text oh-desktop" data-wow-delay=".1s"><span class="cta-modern-decor wow slideInLeft"></span><span class="d-inline-block wow slideInDown">Donación segura con PayPal</span></p><a class="button button-md button-secondary-2 button-winona wow fadeInUp" href="apoyo" data-wow-delay=".2s">aportar</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Section CTA-->
  <section class="primary-overlay section parallax-container" data-parallax-img="img4k/pexels-pavel-danilyuk-72342556.jpg">
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3">
          ...
          <article class="product wow fadeInLeft" data-wow-delay=".15s">
            ...
            <div class="product-button">
              <div class="button-wrap"><a class="button button-xs button-primary button-winona" target="en _blank" href="https://es.wikipedia.org/wiki/Inma_Cuesta">info</a></div>
              <div class="button-wrap"><a class="button button-xs button-secondary button-winona" target="en _blank" href="https://www.instagram.com/inmakum/?hl=es">instagram</a></div>
            </div>
          </article>
        </div>
        <div class="col-sm-6 col-lg-4 col-xl-3">
    ...
    <div class="container-fluid container-inset-0 isotope-wrap">
      <div class="row row-10 gutters-10 isotope" data-isotope-layout="masonry" data-isotope-group="gallery" data-lightgallery="group">
        <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
          <!-- Thumbnail Mary-->
          <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft"><a class="thumbnail-mary-figure" href="img4k/pexels-photo-3644048.jpeg" data-lightgallery="item"><img src="img4k/pexels-photo-3644048.jpeg" alt="" width="310" height="585"/></a>
