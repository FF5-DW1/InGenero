...
<div class="m-5">
                ...
                <div class="col-lg-4 col-xl-3">
                    ...
                    <ul class="nav list-category list-category-down-md-inline-block">
                        <li class="list-category-item wow fadeInRight" role="presentation" data-wow-delay="0s"><a
                                class="active" href="#tabs-4-1" data-toggle="tab">Nuestra historia</a></li>
                        <li class="list-category-item wow fadeInRight" role="presentation" data-wow-delay=".2s"><a
                                href="#tabs-4-3" data-toggle="tab">Objetivos y metas a futuro</a></li>
                        <li class="list-category-item wow fadeInRight" role="presentation" data-wow-delay=".3s"><a
                                href="#tabs-4-4" data-toggle="tab">Valores</a></li>
                    ...
                    <div class="tab-content tab-content-1">
                        <div class="tab-pane fade show active" id="tabs-4-1">
                            ...
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                ...
                                consectetur.</p><img src="img4k/HD-wallpaper-people-beside-stage.jpg" alt=""
                        ...
                        <div class="tab-pane fade" id="tabs-4-3">
                            ...
                            <p>Lotus advenas ducunt ad gemna. Ubi est domesticus domina? Heu, barbatus mens! Cum elogium
                                ...
                                danista. Dominas sunt accentors de germanus cacula. Amicitias prarere in alta muta! Ecce,
                                bubo! Nunquam promissio verpa. Talis, primus fugas recte consumere de audax, festus
                                indictio. Nunquam quaestio scutum. Valebats</p><img
                                src="img4k/free-photo-of-preparando-grupo-chicas-actuacion.jpeg" alt=""
                                width="835" height="418" />
                        </div>
                        <div class="tab-pane fade" id="tabs-4-4">
                            <h4>Valores</h4>
                            <p>Albus, dexter particulas grauiter consumere de ferox, bi-color abactus. Impositios studere,
                                tanquam mirabilis hippotoxota. Cur torus manducare? Pol, vox! Cum barcas nocere, omnes
                                specieses contactus</p>
                            <p>Lotus advenas ducunt ad gemna. Ubi est domesticus domina? Heu, barbatus mens! Cum elogium
                                favere, omnes lubaes tractare talis, barbatus adiuratores. Mirabilis hydras ducunt ad
                                danista. Dominas sunt accentors de germanus cacula. Amicitias prarere in alta muta! Ecce,
                                bubo! Nunquam promissio verpa. Talis, primus fugas recte consumere de audax, festus
                                indictio. Nunquam quaestio scutum. Valebats</p><img src="images/about-1-835x418.jpg"
    ...
    <section class="section section-lg section-bottom-md-70 bg-default" id="nosotrasOurTeamSobrescrito">
        <div class="container">
            <h3 class="oh"><span class="d-inline-block wow slideInUp" data-wow-delay="0s">FUNDADORES</span></h3>
                ...
                <div class="col-md-9 col-lg-6 position-static index-1">
                    <div class="bg-image-right-1 bg-image-right-lg"><img src="images/our_history-1110x710.jpg"
                        ...
                        <div class="link-play-modern"><a class="icon mdi mdi-play" data-lightgallery="item"
                                href="https://www.youtube.com/watch?v=UR7LAW-VBBk"></a>
