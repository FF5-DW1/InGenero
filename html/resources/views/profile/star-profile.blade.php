...
<div>
    ...
    <div class="bg-rose-600 p-4 mt-28">
        <div class="max-w-2xl mx-auto bg-rose-600 overflow-hidden">
            ...
            <h1 class="text-3xl text-white font-bold mb-2 justify-center mt-10 ">Patricia Nogal</h1>
...
{{--             <div id="default-carousel" class="relative w-full" data-carousel="slide">
                ...
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('img/actress.svg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                    <!-- Item 2 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('img/actress.svg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
 ...
 --}}
            ...
            <div id="custom-controls-gallery" class="relative w-full" data-carousel>
                ...
                <div class="relative h-48 overflow-hidden rounded-lg md:h-96">
                    <!-- Item 1 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('img/actress.svg') }}" class="absolute block max-w-full h-auto -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
                    </div>
                    <!-- Item 2 -->
                ...
                <div class="flex items-center justify-center pt-4">
                    <button type="button" class="flex items-center justify-center mr-4 h-full cursor-pointer group focus:outline-none" data-carousel-prev>
                        <span class="text-gray-400 hover:text-gray-900 dark:hover:text-white group-focus:text-gray-900 dark:group-focus:text-white">
                           <img src="{{ asset('img/arrow_letf.svg')}}" alt="arrow letf" >
                            <span class="sr-only">Previous</span>
                        </span>
                    </button>
